            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                     ...
                     $catergory_counts = mysqli_num_rows($select_all_categories);
                     
                     echo "<div class='huge'>{$catergory_counts}</div>"
     ...
     ?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $unapproved_comment_count, $user_counts, $subscriber_count, $catergory_counts];
